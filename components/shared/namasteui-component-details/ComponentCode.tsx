...
export default function ComponentCode({ componentName }: ComponentProps) {
    ...
    return (
        <div className="flex justify-between bg-black95 dark:bg-black100 items-center px-6 pt-2 pb-4 border border-muted-foreground/30 rounded-lg w-full relative">
